!function (e, t) {
                        ...
                        return m.next = function () {
                            ...
                            if (i) {
                                ...
                                if (r && e(r).hasClass("carousel")) {
                                    ...
                                    c && (l.interval = !1), a._jQueryInterface.call(e(r), l), c && e(r).data(n).to(c), t.preventDefault()
                                }
                            }
                        }, r(a, null, [{
                            key: "VERSION",
    ...
    function () {
        var e, t, n, i, r, o, s, a, l, c, u, f, d, p, h, m, g, v, y, b, w, _, E, x, T, C, A, S, j, N, D, k, O, I, L, P,
            q, H, R, M, F, W, U, B, K, V, Q, $, G, z = [].slice,
            Y = {}.hasOwnProperty,
            X = function (e, t) {
                function n() {
                    this.constructor = e
...
var MODULE_CONFIG = {
        chat: ["/libs/list.js/dist/list.js", "/libs/notie/dist/notie.min.js", "/scripts/plugins/notie.js", "/scripts/app/chat.js"],
        mail: ["/libs/list.js/dist/list.js", "/libs/notie/dist/notie.min.js", "/scripts/plugins/notie.js", "/scripts/app/mail.js"],
        ...
        dataTable: ["/libs/datatables/media/js/jquery.dataTables.min.js", "/libs/datatables.net-bs4/js/dataTables.bootstrap4.js", "/libs/datatables.net-bs4/css/dataTables.bootstrap4.css", "/scripts/plugins/datatable.js"],
        bootstrapTable: ["/libs/bootstrap-table/dist/bootstrap-table.min.css", "/libs/bootstrap-table/dist/bootstrap-table.min.js", "/libs/bootstrap-table/dist/local/zh-cn.js", "/libs/bootstrap-table/dist/extensions/export/bootstrap-table-export.min.js", "/libs/bootstrap-table/dist/extensions/mobile/bootstrap-table-mobile.min.js", "/scripts/plugins/tableExport.min.js", "/scripts/plugins/bootstrap-table.js"],
        ...
        datetimepicker: ["/libs/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css", "/libs/moment/min/moment-with-locales.min.js", "/libs/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js", "/scripts/plugins/datetimepicker.js"],
        ...
        summernote: ["https://cdn.bootcss.com/summernote/0.8.10/summernote.css", "https://cdn.bootcss.com/summernote/0.8.10/summernote-bs4.css", "https://cdn.bootcss.com/summernote/0.8.10/summernote.min.js", "https://cdn.bootcss.com/summernote/0.8.10/summernote-bs4.min.js", "https://cdn.bootcss.com/summernote/0.8.10/lang/summernote-zh-CN.min.js"],
        ...
        jqueryConfirm: ["/libs/jquery-confirm/jquery-confirm.min.css", "/libs/jquery-confirm/jquery-confirm.min.js", "/scripts/plugins/jquery-confirm.js"],
        ajaxForm: ["/scripts/ajax.form.js"],
        sha256: ["/scripts/sha256.js"]
    },
...
!function (e, t) {
    ...
    var n = [],
        ...
        r = e.Deferred();
    t.load = function (t) {
        return t = e.isArray(t) ? t : t ? t.split(/\s+/) : '', i || (i = r.promise()), e.each(t, function (e, t) {
            i = i.then(function () {
    ...
    function (e) {
        ...
        function t() {
            ...
            t.length > 0 , e("#aside .active").removeClass("active"), e("#aside a").filter(function () {
                return e(this).attr("href") ? t.indexOf(e(this).attr("href")) > -1 : false
